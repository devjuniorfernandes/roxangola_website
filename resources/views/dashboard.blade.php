<x-app-layout>
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="bg-white overflow-hidden shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl group relative">
            <div class="p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0 bg-sky-50 text-sky-600 rounded-lg p-3 group-hover:bg-sky-600 group-hover:text-white transition-colors duration-300">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">Cards da página Serviços (PT/EN)</dt>
                            <dd class="text-2xl font-semibold text-gray-900">Serviços</dd>
                        </dl>
                    </div>
                </div>
            </div>
            <div class="bg-gray-50 px-6 py-3">
                <div class="text-sm">
                    <a href="{{ route('admin.services.index') }}" class="font-medium text-sky-600 hover:text-sky-500 flex items-center justify-between"><span>Gerir cards de serviços</span><span aria-hidden="true">&rarr;</span></a>
                </div>
            </div>
            <a href="{{ route('admin.services.index') }}" class="absolute inset-0"></a>
        </div>
    </div>
</x-app-layout>
