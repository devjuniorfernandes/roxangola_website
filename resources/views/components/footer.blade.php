    <footer class="bg-black text-white pt-10 pb-10">
        <div class="site-container">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start mb-6 gap-4">
                ...
                <p class="text-[11px] text-gray-500 font-light italic">* As imagens são apenas para referência, sujeitas ao veículo entregue.</p>
            </div>

            <!-- Contact -->
            <div class="mb-6">
                <h4 class="text-sm font-medium text-white mb-3">Contacte-nos</h4>
                <div class="flex flex-col md:flex-row gap-3 md:gap-0 text-sm text-white">
                    <span class="flex items-center gap-2">Pós-Venda: <a href="mailto:info@roxangola.com" class="text-white hover:text-white/70 transition-colors ml-1">info@roxangola.com</a>
                        <button class="copy-btn text-white hover:text-white/70 transition-colors" data-copy="info@roxangola.com" title="Copiar">
                    ...
                    <span class="hidden md:inline text-white/30 mx-6">|</span>
                    <span class="flex items-center gap-2">Marketing & Vendas: <a href="mailto:vendas@roxangola.com" class="text-white hover:text-white/70 transition-colors ml-1">vendas@roxangola.com</a>
            ...
            <div class="flex gap-3 mb-8">
                ...
                <a href="#" target="_blank" rel="noopener noreferrer" class="w-9 h-9 rounded-full border border-white/30 flex items-center justify-center text-white hover:text-white hover:border-white/60 transition-all duration-300">
            ...
            <div class="border-t border-white/10 pt-5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div class="flex flex-wrap items-center gap-4 md:gap-6 text-xs text-white font-medium tracking-wide">
                    ...
                    <a href="#" class="hover:text-white/70 transition-colors">Marca</a>
                    <a href="#" class="hover:text-white/70 transition-colors">Manual</a>
                    <a href="{{ route('politica-privacidade') }}" class="hover:text-white/70 transition-colors">Política de Privacidade</a>
                </div>
                <p class="text-xs text-white">Copyright &copy;{{ date('Y') }} ROX Angola</p>
            </div>
        </div>
    </footer>
    <script>
