    <footer class="bg-black text-white pt-12 pb-8">
        <div class="site-container">
            ...
            <!-- Contact -->
            <div class="mb-6">
                <h4 class="text-sm font-medium text-gray-300 mb-3">Contacte-nos</h4>
                <div class="flex flex-col md:flex-row gap-2 md:gap-8 text-sm text-gray-400 font-mono">
                    <span>Pós-Venda: <a href="mailto:info@roxangola.com" class="text-gray-300 hover:text-white transition-colors">info@roxangola.com</a></span>
                    <span class="hidden md:inline text-gray-600">|</span>
                    <span>Marketing & Vendas: <a href="mailto:vendas@roxangola.com" class="text-gray-300 hover:text-white transition-colors">vendas@roxangola.com</a></span>
                </div>
            </div>

            <!-- Social icons -->
            <div class="flex gap-4 mb-10">
                <a href="https://www.facebook.com/roxmotor.ao" target="_blank" rel="noopener noreferrer" class="w-9 h-9 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-gray-400 transition-all duration-300">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="https://www.instagram.com/roxmotor.ao" target="_blank" rel="noopener noreferrer" class="w-9 h-9 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-gray-400 transition-all duration-300">
