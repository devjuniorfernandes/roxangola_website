    <footer class="bg-black text-white pt-12 pb-8">
        <div class="max-w-[1920px] mx-auto px-6 md:px-40">
            ...
            <div class="flex gap-4 mb-10">
                <a href="#" class="w-9 h-9 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-gray-400 transition-all duration-300">
