        ...
        <div class="site-container">
            ...
            <div class="mb-6">
                ...
                <div class="flex flex-col md:flex-row gap-3 md:gap-0 text-sm text-white">
                    <span class="flex items-center gap-2">{{ __('common.footer.marketing_sales') }} <a href="mailto:vendas@roxangola.com" class="text-white hover:text-white/70 transition-colors ml-1">vendas@roxmotor.ao</a>
