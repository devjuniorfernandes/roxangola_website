    ...
    <div class="site-container flex items-center justify-between h-[60px]">
        ...
        <div class="hidden md:flex items-center space-x-10 text-[13px] font-medium">
            <div class="relative nav-item" data-has-mega="modelos">
                <span class="group relative pb-1 cursor-pointer transition-colors">Modelos <span class="absolute bottom-0 left-0 w-full h-px transition-transform duration-300 origin-left {{ Request::is('rox-01', 'rox-adamas', 'catalogo') ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100' }}" style="background: var(--rox-dune-yellow);"></span></span>
            </div>
            <div class="relative nav-item" data-has-mega="concessionaria">
                <span class="group relative pb-1 cursor-pointer transition-colors">Concessionária <span class="absolute bottom-0 left-0 w-full h-px transition-transform duration-300 origin-left {{ Request::is('concessionaria', 'showroom') ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100' }}" style="background: var(--rox-dune-yellow);"></span></span>
            </div>
            <a href="{{ route('revendedores') }}" class="group relative pb-1 transition-colors nav-item">Revendedores <span class="absolute bottom-0 left-0 w-full h-px transition-transform duration-300 origin-left {{ Request::is('revendedores') ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100' }}" style="background: var(--rox-dune-yellow);"></span></a>
            <div class="relative nav-item" data-has-mega="servicos">
                <span class="group relative pb-1 cursor-pointer transition-colors">Serviços <span class="absolute bottom-0 left-0 w-full h-px transition-transform duration-300 origin-left {{ Request::is('servicos', 'servicos/*') ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100' }}" style="background: var(--rox-dune-yellow);"></span></span>
            </div>
            <div class="relative nav-item" data-has-mega="sobre">
                <span class="group relative pb-1 cursor-pointer transition-colors">Sobre Nós <span class="absolute bottom-0 left-0 w-full h-px transition-transform duration-300 origin-left {{ Request::is('sobre/*') ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100' }}" style="background: var(--rox-dune-yellow);"></span></span>
            </div>
    ...
    <div class="site-container py-6 md:py-8">
        <div class="grid grid-cols-3 gap-4 md:gap-6" style="max-width: 680px;">
            ...
            <a href="{{ route('catalogo') }}" class="group block">
                ...
                <h3 class="text-xs md:text-[13px] font-normal text-black mb-0.5">Catálogo ROX Motor Angola</h3>
                <p class="text-[10px] md:text-[11px] text-gray-400 font-light leading-snug">Descarregue o catálogo oficial</p>
            </a>
        </div>
    </div>
</div>
    ...
    <div class="site-container py-6 md:py-8">
        <div class="grid grid-cols-2 gap-4 md:gap-6" style="max-width: 480px;">
            <a href="{{ route('concessionaria') }}" class="group block">
                ...
                <h3 class="text-xs md:text-[13px] font-normal text-black mb-0.5">OCTA Mobil</h3>
                <p class="text-[10px] md:text-[11px] text-gray-400 font-light leading-snug">Distribuidor oficial ROX em Angola</p>
            </a>
            <a href="{{ route('showroom') }}" class="group block">
                ...
                <h3 class="text-xs md:text-[13px] font-normal text-black mb-0.5">Showroom</h3>
                <p class="text-[10px] md:text-[11px] text-gray-400 font-light leading-snug">Agende uma visita ao showroom</p>
            </a>
        </div>
    </div>
</div>
    ...
    <div class="site-container py-6 md:py-8">
        <div class="flex gap-8 lg:gap-12">
            <a href="{{ route('servicos.agendamento') }}" class="group block">
                ...
                <h3 class="text-xs md:text-[13px] font-normal text-black mb-0.5">Serviço por Agendamento</h3>
                <p class="text-[10px] md:text-[11px] text-gray-400 font-light leading-snug">Agende o seu serviço online</p>
            </a>
            <a href="{{ route('servicos.apoio-tecnico') }}" class="group block">
                ...
                <h3 class="text-xs md:text-[13px] font-normal text-black mb-0.5">Apoio Técnico & Manutenção</h3>
                <p class="text-[10px] md:text-[11px] text-gray-400 font-light leading-snug">Assistência técnica especializada</p>
            </a>
            <div class="flex flex-col gap-3 py-1">
                <a href="{{ route('servicos.pecas-acessorios') }}" class="text-[13px] font-medium text-gray-600 hover:text-black transition-colors">Peças e Acessórios</a>
                <a href="{{ route('servicos.manual-instrucoes') }}" class="text-[13px] font-medium text-gray-600 hover:text-black transition-colors">Manual de Instruções</a>
                <a href="{{ route('servicos.manual-desmontagem') }}" class="text-[13px] font-medium text-gray-600 hover:text-black transition-colors">Manual de Desmontagem</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="site-container py-6 md:py-8">
        <div class="flex gap-8 lg:gap-12">
            <a href="{{ route('sobre.marca') }}" class="group block">
                ...
                <h3 class="text-xs md:text-[13px] font-normal text-black">A Marca</h3>
            </a>
            <div class="flex flex-col gap-3 py-1">
                <a href="{{ route('sobre.historia') }}" class="text-[13px] font-medium text-gray-600 hover:text-black transition-colors">A História</a>
                <a href="{{ route('sobre.comunidade') }}" class="text-[13px] font-medium text-gray-600 hover:text-black transition-colors">Comunidade ROX Motor Angola</a>
            </div>
        </div>
    </div>
</div>
...
<div id="mobile-sidebar" class="fixed inset-y-0 left-0 w-[85%] max-w-sm bg-[#f4f6f9] z-[100] transform -translate-x-full transition-transform duration-300 flex flex-col justify-between shadow-2xl">
    <div>
        ...
        <nav class="flex flex-col p-8 gap-8 bg-[#f4f6f9]">
            <!-- Modelos -->
            <div>
                <span class="text-[13px] tracking-widest uppercase font-medium text-black pb-1 inline-block">Modelos</span>
                <div class="flex flex-col gap-4 mt-4 pl-4 border-l border-gray-300">
                    <a href="{{ route('rox-adamas') }}" class="text-[12px] tracking-widest uppercase font-medium {{ Request::is('rox-adamas') ? 'text-black' : 'text-gray-500' }} hover:text-black transition-colors">ROX ADAMAS</a>
                    <a href="{{ route('rox01') }}" class="text-[12px] tracking-widest uppercase font-medium {{ Request::is('rox-01') ? 'text-black' : 'text-gray-500' }} hover:text-black transition-colors">ROX 01</a>
                    <a href="{{ route('catalogo') }}" class="text-[12px] tracking-widest uppercase font-medium {{ Request::is('catalogo') ? 'text-black' : 'text-gray-500' }} hover:text-black transition-colors">Catálogo</a>
                </div>
            </div>
            <!-- Concessionária -->
            <div>
                <span class="text-[13px] tracking-widest uppercase font-medium text-black pb-1 inline-block">Concessionária</span>
                <div class="flex flex-col gap-4 mt-4 pl-4 border-l border-gray-300">
                    <a href="{{ route('concessionaria') }}" class="text-[12px] tracking-widest uppercase font-medium {{ Request::is('concessionaria') ? 'text-black' : 'text-gray-500' }} hover:text-black transition-colors">OCTA Mobil</a>
                    <a href="{{ route('showroom') }}" class="text-[12px] tracking-widest uppercase font-medium {{ Request::is('showroom') ? 'text-black' : 'text-gray-500' }} hover:text-black transition-colors">Showroom</a>
                </div>
            </div>
            <a href="{{ route('revendedores') }}" class="group relative text-[13px] tracking-widest uppercase font-medium text-black pb-1 inline-block">Revendedores <span class="absolute bottom-0 left-0 w-full h-px transition-transform duration-300 origin-left {{ Request::is('revendedores') ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100' }}" style="background: var(--rox-dune-yellow);"></span></a>
            <!-- Serviços -->
            <div>
                <span class="text-[13px] tracking-widest uppercase font-medium text-black pb-1 inline-block">Serviços</span>
                <div class="flex flex-col gap-4 mt-4 pl-4 border-l border-gray-300">
                    <a href="{{ route('servicos.agendamento') }}" class="text-[12px] tracking-widest uppercase font-medium {{ Request::is('servicos/agendamento') ? 'text-black' : 'text-gray-500' }} hover:text-black transition-colors">Agendamento</a>
                    <a href="{{ route('servicos.apoio-tecnico') }}" class="text-[12px] tracking-widest uppercase font-medium {{ Request::is('servicos/apoio-tecnico') ? 'text-black' : 'text-gray-500' }} hover:text-black transition-colors">Apoio Técnico</a>
                    <a href="{{ route('servicos.pecas-acessorios') }}" class="text-[12px] tracking-widest uppercase font-medium {{ Request::is('servicos/pecas-acessorios') ? 'text-black' : 'text-gray-500' }} hover:text-black transition-colors">Peças e Acessórios</a>
                    <a href="{{ route('servicos.manual-instrucoes') }}" class="text-[12px] tracking-widest uppercase font-medium {{ Request::is('servicos/manual-instrucoes') ? 'text-black' : 'text-gray-500' }} hover:text-black transition-colors">Manual de Instruções</a>
                    <a href="{{ route('servicos.manual-desmontagem') }}" class="text-[12px] tracking-widest uppercase font-medium {{ Request::is('servicos/manual-desmontagem') ? 'text-black' : 'text-gray-500' }} hover:text-black transition-colors">Manual de Desmontagem</a>
                </div>
            </div>
            <!-- Sobre Nós -->
            <div>
                <span class="text-[13px] tracking-widest uppercase font-medium text-black pb-1 inline-block">Sobre Nós</span>
                <div class="flex flex-col gap-4 mt-4 pl-4 border-l border-gray-300">
                    <a href="{{ route('sobre.marca') }}" class="text-[12px] tracking-widest uppercase font-medium {{ Request::is('sobre/marca') ? 'text-black' : 'text-gray-500' }} hover:text-black transition-colors">A Marca</a>
                    <a href="{{ route('sobre.historia') }}" class="text-[12px] tracking-widest uppercase font-medium {{ Request::is('sobre/historia') ? 'text-black' : 'text-gray-500' }} hover:text-black transition-colors">A História</a>
                    <a href="{{ route('sobre.comunidade') }}" class="text-[12px] tracking-widest uppercase font-medium {{ Request::is('sobre/comunidade') ? 'text-black' : 'text-gray-500' }} hover:text-black transition-colors">Comunidade ROX</a>
                </div>
            </div>
