<!-- Desktop Navbar -->
<nav class="fixed w-full z-50 transition-all duration-300 {{ Request::is('/', 'rox-01', 'rox-adamas', 'catalogo', 'concessionaria', 'showroom', 'revendedores') ? 'nav-glass border-b text-white nav-transparent' : 'bg-white border-b border-gray-200 text-black' }}" id="navbar">
    <div class="site-container flex items-center justify-between h-[60px]">
        ...
        <a href="{{ route('home') }}" class="flex-shrink-0 flex items-center gap-3">
            @if(Request::is('/', 'rox-01', 'rox-adamas', 'catalogo', 'concessionaria', 'showroom', 'revendedores'))
