    ...
    @php
        ...
        if (!$isEnglish && $initialModel === 'rox-adamas') {
            $ptSpecs = [
                ...
                'Middle East–exclusive high-power A/C compressor' => 'Compressor de ar condicionado de elevada potência exclusivo para o Médio Oriente', 'Sun visor (with vanity mirror and lamp)' => 'Pala de sol (com espelho de cortesia e iluminação)', 'Seat massage' => 'Massagem dos bancos', 'Maximum wading depth*' => 'Profundidade máxima de vadeamento*', 'Microfiber suede headliner' => 'Forro do tejadilho em camurça de microfibra',
