    ...
    @php
        ...
        if (!$isEnglish && $initialModel === 'rox-adamas') {
            $ptSpecs = [
                ...
                'Middle East–exclusive high-power A/C compressor' => 'Compressor de Climatização de Alta Potência', 'Sun visor (with vanity mirror and lamp)' => 'Pala Solar (com espelho e iluminação)', 'Seat massage' => 'Massagem dos bancos', 'Maximum wading depth*' => 'Profundidade máxima de travessia*', 'Microfiber suede headliner' => 'Forro do tejadilho em camurça de microfibra',
