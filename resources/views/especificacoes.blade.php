    ...
    @php
        ...
        $colorRows = [
            'rox-01' => [
                ...
                ['label' => 'Série Especial Black Knight — Kit Exterior All Black (incluindo acabamento em aço tungstênio)', 'color' => '#2d2d2d', 'image' => 'assets/rox_1/interior/swatches/black exterior.png', '7' => '&#9675;', '6' => '&#9675;'],
        ...
        $sections['todo_terreno'] = [
            ...
            'rows' => array_merge($standardRows([
                'Modo ROX: Areia', 'Modo ROX: Travessia',
            ], 'rox-01'), [
                ...
                ['label' => 'Profundidade máxima de travessia', '7' => '770 mm', '6' => '770 mm', 'model' => 'rox-adamas'],
                ['label' => 'Modos todo-o-terreno', '7' => 'Auto, Estrada, Montanha, Lama, Areia, Neve e Travessia', '6' => 'Auto, Estrada, Montanha, Lama, Areia, Neve e Travessia', 'model' => 'rox-adamas'],
        ...
        $sections['interior_comforto'] = [
            ...
            'rows' => array_merge($standardRows([
                ...
                'Forro do tejadilho em camurça de microfibra', 'Ar condicionado automático de três zonas',
        ...
        $sections['exterior'] = [
            ...
            'rows' => array_merge($standardRows([
                ...
                'Para-brisas laminado termo-isolante', 'Vidros da 1.ª fila de dupla camada com isolamento acústico', 'Vidros da 2.ª fila de dupla camada com isolamento acústico', 'Vidros da 3.ª fila de dupla camada com isolamento acústico', 'Tejadilho panorâmico de dois painéis com vidro de isolamento térmico/acústico', 'Cortina elétrica do tejadilho panorâmico de dois painéis',
                ...
                'Tejadilho de vidro dianteiro e tejadilho panorâmico traseiro com cortinas elétricas',
            ], 'rox-adamas')),
        ];
        ...
        $sections['conducao_inteligente'] = [
            ...
            'rows' => array_merge($standardRows([
                ...
                'Vista transparente da zona inferior e deteção de profundidade de travessia',
            ], 'rox-adamas')),
        ];
        ...
        $sections['seguranca_avancada'] = [
            ...
            'rows' => array_merge($standardRows([
                ...
                'Modo de reboque para assistência em estrada', 'Kit de primeiros socorros',
            ], 'rox-adamas')),
        ];
        ...
        if (!$isEnglish && $initialModel === 'rox-adamas') {
            $ptSpecs = [
                ...
                '21-inch two-tone starlight wheel with all-season tire' => 'Jante starlight de 21” em dois tons com pneu para todas as estações', '21-inch black starlight wheel with all-season tire' => 'Jante starlight preta de 21” com pneu para todas as estações', 'Tailgate-mounted full-size spare tire' => 'Pneu suplente de tamanho completo montado na porta da bagageira', 'Roof rail tracks' => 'Calhas de tejadilho', 'Towing package' => 'Pré Instalação de Kit de Reboque',
        ...
        <div class="site-container">
            ...
            <section class="mt-10 border-t border-gray-200 pt-8 {{ $initialModel === 'rox-adamas' ? '' : 'hidden' }}" data-model-spec="rox-adamas">
                ...
                <ol class="mt-4 list-decimal space-y-2 pl-5 text-xs leading-relaxed text-gray-500">
                    ...
                    <li>A profundidade máxima de travessia é de 770 mm no modo Recovery. Evite condução dinâmica ou imersão prolongada a esta profundidade; o habitáculo é uma área seca e deve ser evitada a entrada de água.</li>
                    ...
                    <li>As funções LCC, FAEB, FCW, RAEB, IHBC, APA, RPA, ISRS, deteção de profundidade de travessia, DVR panorâmico HD, modo sentinela urbano, modo sentinela de campismo e chassis transparente estão previstas para atualização OTA ou pós-venda no primeiro trimestre de 2026.</li>
