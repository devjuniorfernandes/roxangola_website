<x-front-layout>
    <x-slot name="title">{{ __('concessionaria.title') }}</x-slot>
    ...
    <section class="relative h-[100svh] w-full overflow-hidden flex items-end">
        ...
        <div class="relative z-40 pb-32 md:pb-36 w-full">
            <div class="site-container">
                <p class="text-sm sm:text-base md:text-lg font-light text-gray-200 tracking-wide mb-3 opacity-0 translate-y-8" style="animation: heroSlideUp 0.8s ease-out 0.3s forwards;">{{ __('concessionaria.hero.eyebrow') }}</p>
                <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium text-white max-w-3xl opacity-0 translate-y-8" style="animation: heroSlideUp 0.8s ease-out 0.5s forwards;">{{ __('concessionaria.hero.title') }}</h1>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 md:py-24 bg-white overflow-hidden">
        <div class="content-container">
            <div class="mb-14 md:mb-20 animate-up">
                <p class="text-sm md:text-base font-semibold tracking-wide mb-4">{{ __('concessionaria.services.eyebrow') }}</p>
                <h2 class="text-3xl md:text-4xl font-normal tracking-wide mb-4">{{ __('concessionaria.services.title') }}</h2>
                <p class="text-base md:text-lg text-gray-500 font-light max-w-3xl">{{ __('concessionaria.services.intro') }}</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
                ...
                <div class="relative h-[400px] md:h-[550px] overflow-hidden group animate-up">
                    ...
                    <a href="{{ route('contactos') }}" class="absolute bottom-6 md:bottom-8 right-6 md:right-8 flex items-center gap-2 bg-white/20 backdrop-blur-sm text-white text-sm font-medium px-5 py-2.5 rounded-full transition-all duration-300 hover:bg-white/40">
                        {{ __('common.more') }} <span class="w-5 h-5 rounded-full bg-white text-black flex items-center justify-center text-xs font-bold">+</span>
                    </a>
                </div>
                @endforeach
            </div>
    ...
    <section class="py-20 md:py-28 bg-black text-white">
        <div class="content-container">
            <div class="mb-14 md:mb-20 animate-up">
                <h2 class="text-3xl md:text-4xl font-normal tracking-wide mb-4">{{ __('concessionaria.contact.title') }}</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-6">
                ...
                <div class="animate-up">
                    ...
                    <p class="text-sm text-white/50 font-light mb-2">{{ __('common.forms.phone') }}</p>
                ...
                <div class="animate-up">
                    ...
                    <p class="text-sm text-white/50 font-light mb-2">{{ __('common.forms.email') }}</p>
                ...
                <div class="animate-up">
                    ...
                    <p class="text-sm text-white/50 font-light mb-2">{{ __('concessionaria.contact.website') }}</p>
                ...
                <div class="animate-up">
                    ...
                    <p class="text-sm text-white/50 font-light mb-3">{{ __('concessionaria.contact.social') }}</p>
                    <div class="flex gap-4">
                        ...
                        <a href="https://www.linkedin.com/company/octamobil/" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:border-[#C5A059] hover:text-[#C5A059] transition-all duration-300" aria-label="LinkdIn">
            ...
            <div class="mt-16 animate-up">
                <a href="{{ route('contactos') }}" class="inline-block px-8 py-3 text-sm font-medium tracking-widest uppercase border border-white/30 text-white hover:bg-white hover:text-black transition-all duration-300">{{ __('common.footer.contact_us') }}</a>
            </div>
        </div>
    </section>
</x-front-layout>
