<x-front-layout>
    ...
    <section class="relative h-[100svh] w-full overflow-hidden" id="catalogo-hero-slider" data-duration="6000">
        ...
        <!-- Slide 2 -->
        <div class="catalogo-slide absolute inset-0 z-10 opacity-0 transition-opacity duration-[1400ms] ease-in-out" data-catalogo-slide data-title="{{ __('catalogo.hero.title') }}" data-subtitle="{{ __('catalogo.hero.sub2') }}">
            <img src="{{ asset('assets/banner.jpg') }}" alt="ROX Motor" class="h-full w-full object-cover">
        </div>
        <!-- Slide 3 -->
        <div class="catalogo-slide absolute inset-0 z-10 opacity-0 transition-opacity duration-[1400ms] ease-in-out" data-catalogo-slide data-title="{{ __('catalogo.hero.title') }}" data-subtitle="{{ __('catalogo.hero.sub3') }}">
        ...
        <div class="absolute inset-x-0 bottom-0 z-40 pb-32 md:pb-36">
            <div class="site-container">
                <h1 id="catalogo-hero-title" class="text-3xl sm:text-4xl md:text-5xl font-medium text-white mb-4 md:mb-5 transition-all duration-700 opacity-0 translate-y-8" style="animation: heroSlideUp 0.8s ease-out 0.3s forwards;">{{ __('catalogo.hero.title') }}</h1>
                <p id="catalogo-hero-subtitle" class="text-sm sm:text-base md:text-lg font-light text-gray-200 tracking-wide max-w-2xl opacity-0 translate-y-8" style="animation: heroSlideUp 0.8s ease-out 0.5s forwards;">{{ __('catalogo.hero.sub1') }}</p>
            </div>
        </div>
    ...
    <section class="bg-black text-white py-20 md:py-28">
        <div class="content-container">
            <h2 class="text-3xl md:text-4xl font-normal tracking-wide mb-12 md:mb-16 animate-up">{{ __('catalogo.cards.title') }}</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                ...
                <a href="{{ asset('assets/Catalogo_ROX_PT_baixa.pdf') }}" download="Catalogo_ROX_PT_baixa.pdf" class="animate-up block group">
                    ...
                    <div class="bg-[#1a1a1a] text-white px-5 sm:px-6 md:px-8 h-[120px] sm:h-[130px] md:h-[140px] flex items-start pt-4 sm:pt-5 md:pt-6 justify-between gap-4">
                        <div>
                            <h3 class="text-base sm:text-lg md:text-xl font-semibold mb-2 sm:mb-3">{{ __('catalogo.cards.download_title') }}</h3>
                            <p class="text-xs md:text-sm text-gray-400 font-light leading-relaxed">{{ __('catalogo.cards.download_desc') }}</p>
                        </div>
                ...
                <a href="{{ asset('assets/Catalogo_ROX_PT_baixa.pdf') }}" target="_blank" rel="noopener noreferrer" class="animate-up block group">
                    ...
                    <div class="bg-[#1a1a1a] text-white px-5 sm:px-6 md:px-8 h-[120px] sm:h-[130px] md:h-[140px] flex items-start pt-4 sm:pt-5 md:pt-6 justify-between gap-4">
                        <div>
                            <h3 class="text-base sm:text-lg md:text-xl font-semibold mb-2 sm:mb-3">{{ __('catalogo.cards.view_title') }}</h3>
                            <p class="text-xs md:text-sm text-gray-400 font-light leading-relaxed">{{ __('catalogo.cards.view_desc') }}</p>
                        </div>
